...
export default function DNGNProjectComponent() {
    return (<div>
        ...
        <div className={styles.center} id="DNGN">
            <Common.Icon src="./icon_DNGN.png" alt="DNGN Icon" width="256" height="256" />
            <iframe src="https://www.youtube.com/embed/x7JMQEBYFqI" width="560" height="315" title="A YouTube video" frameBorder="0" allowFullScreen></iframe>
        </div>
